...
#'@examples
#'data(Korea)
#'z=sortmodelsbic(Korea, checkexist=T)
...
#'
#' The routine subsets the results matrix as part of the output given by \code{sortmodelsbic}
...
#'
#'
#' @param z output from \code{sortmodelsbic} or a list output from applying \code{sortmodelsbic}, \code{jackknifecal} and \code{bootstrapcal}.
...
#'   } If the input only has the output from \code{sortmodelsbic}, the last five items of the list
#'   do not appear.
#'
#' @examples
#' data(UKdat_5)
#' #Example 1
#' z=sortmodelsbic(UKdat_5)
...
#'
#' This routine takes the output from \code{sortmodelsbic} or \code{subsetmat} and returns bootstrap
#' abundance matrix and BIC matrix. This version makes use of the \code{checkident.2}.
#'
#' @param z Results from \code{sortmodelsbic} or \code{subsetmat}
...
#'
#' This routine takes the output from \code{subsetmat} or from \code{sortmodelsbic} and returns the jackknife
